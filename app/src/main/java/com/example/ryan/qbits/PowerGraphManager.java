...
public class PowerGraphManager extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_power_graph_manager);
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_power_graph_manager, container, false);
            return rootView;
        }
        ...
        public void onAttach(Activity activity) {
            ...
            ((PowerGraphManager) activity).onSectionAttached(
