...
public class PercentageGraphActivity extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_percentage_graph);
        ...
        LineChart occupancyChart = (LineChart)findViewById(R.id.percentageChart);
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_percentage_graph, container, false);
            return rootView;
        }
        ...
        public void onAttach(Activity activity) {
            ...
            ((PercentageGraphActivity) activity).onSectionAttached(
